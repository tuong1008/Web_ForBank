...
public class UndoAPI extends HttpServlet{
	...
	resp.setContentType("application/json");
        ...
        Connection connection = AbstractDAO.getConnection(session.getAttribute("serverName").toString(), session.getAttribute("user").toString(),
        ...
        try {
            ...
            if (!stackToUndo.isEmpty()){
                ...
                if (sql.contains("SP")){
                    ...
                    String result = employeeService.undoTransferEmployee(req, maNVServerMaCN[0], maNVServerMaCN[1], maNVServerMaCN[2],
                                                                         maNVServerMaCN[3]);
